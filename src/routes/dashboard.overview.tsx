...
function DashboardOverview() {
  ...
  const filteredTransports = mockPublicTransports.filter((transport) => {
    ...
    const targetDate = transportTimeframe === "today" ? today : tomorrow;
    return isSameDay(transportDate, targetDate);
  });
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid gap-6 md:grid-cols-2">
        {/* Public Transports Arriving Soon */}
        <Card>
          <CardHeader>
            <div className="flex items-center justify-between">
              ...
              <Tabs
                value={transportTimeframe}
                onValueChange={(value) =>
                  setTransportTimeframe(value as "today" | "tomorrow")
                }
              >
            ...
            <CardDescription>Upcoming arrivals and departures</CardDescription>
          </CardHeader>
          <CardContent className="space-y-4">
            ...
            {filteredTransports.length === 0 && (
              <div className="py-6 text-center text-muted-foreground">
                No transports scheduled for {transportTimeframe}
              </div>
            )}
          </CardContent>
        </Card>
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            Scheduled activities for the selected date
          </CardDescription>
        </CardHeader>
        <CardContent className="space-y-4">
