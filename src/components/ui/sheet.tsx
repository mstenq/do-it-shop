...
// set modal to false by default due to bug
const Sheet = (
...
const SheetHeader = ({
  ...
  <div
    className={cn("flex flex-col space-y-2 p-6 max-h-[105px]", className)}
    {...props}
  />
);
...
const SheetFooter = ({
  ...
  <div
    className={cn("flex px-6 py-4  justify-end gap-2", className)}
    {...props}
  />
);
